...
\title{SMT Reordering Models without Parallel Corpora}
...
\section{Reordering Model} \label{sect:order}
...
\todo{
\begin{my_itemize}
  \item Pruning of contextual phrases
  \item Weighting counts by monoloingual feature values
  \item All ion the context of (1) how close the reordering features are to the moses reordering table (experiments from way back), and (2) the resulting scores
\end{my_itemize}
}
